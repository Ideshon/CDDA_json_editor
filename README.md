...
- Неблокирующее окно связей выбранного объекта с входящими/исходящими ссылками, переходом к связанным объектам и запоминанием состояния окна.
...
- Запоминание размера главного окна, положения тулбаров, размеров основных панелей и состояния вспомогательных окон в `settings.ini` рядом с программой.
- Логирование в консоль и `logs\editor.log` рядом с программой.
- Отмена и повтор действий редактора через меню и тулбар: создание, удаление, перемещение, переименование объектов и изменения полей.
- Темная тема
